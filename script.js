$(document).ready(function(){
    ...
    $(document).on('click', '.mostrar-detalhes', function(){
        ...
        detalhes.slideDown();
        $(this).attr({
            'src': './imagens/menos-detalhes.png',
            ...
            const novaTarefa = $(`
                <ul id="tarefa">
                    <li id="tarefa-titulo">
                        ...
                        <img src="./imagens/pendente.png" class="concluir" title="Concluir tarefa" alt="Concluir tarefa">
                        <img src="./imagens/excluir.png" class="excluir" title="Excluir tarefa" alt="Excluir tarefa">
                        <img src="./imagens/mais-detalhes.png" class="mostrar-detalhes" title="Mostrar detalhes" alt="Mostrar detalhes" />
                    </li>
